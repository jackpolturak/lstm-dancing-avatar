...
class Preprocessor:
    ...
    def import_normalize(self):
        ...
        dataset = "/Users/jackpolturak/Documents/GitHub/dancing-avatar/Pose data/CSVs/Combined CSVs (Dance + Music)/Kab.csv"
    ...
    def split_sequence(self, sequence, look_back, forecast_horizon):
        ...
        # THIS BIT REMOVES MUSIC FROM LABELS - CHOSE Y_UNSQUEESE FOR THIS MODLE 
